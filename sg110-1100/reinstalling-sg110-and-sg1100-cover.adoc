...
---
= Ersetzen Sie die Abdeckung eines SG110 oder SG1100 Geräts
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Bevor Sie beginnen
link:reinstalling-sg110-and-sg1100-into-cabinet-or-rack.html["Nehmen Sie das Gerät aus dem Schrank oder Rack"] Um auf die obere Abdeckung zuzugreifen.

.Schritte
. Vergewissern Sie sich, dass die Verriegelung der Geräteabdeckung nicht eingerastet ist. Drehen Sie gegebenenfalls die blaue Kunststoffverriegelung um eine Vierteldrehung in Entriegelungsrichtung, wie auf der Verriegelung abgebildet.
...
+
Wenn der Deckel nicht vollständig eingerastet ist, lässt sich das Gerät möglicherweise nicht in das Rack schieben.
...
link:reinstalling-sg110-and-sg1100-into-cabinet-or-rack.html["Setzen Sie das Gerät wieder in den Schrank oder das Rack ein"].
