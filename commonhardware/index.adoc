...
---
= Allgemeine Wartungsverfahren für StorageGRID-Geräte
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:../sg6200/index.html["SG6200-Gerät warten"]
...
* link:../sg120-1200/index.html["Warten Sie die SG120- und SG1200-Appliances"]
