...
---
= Verwenden Sie die Registerkarte „Laufwerke verwalten“ für die SG110, SG120, SG1100, SG1200, SG6100 und SG6200 StorageGRID Appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Im Grid Manager wählen Sie *Knoten* > *_data center_*.
...
[[logically-replace-drivelogically-replace-drive]]
