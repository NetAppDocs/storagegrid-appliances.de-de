...
---
= Anforderungen für das Klonen von StorageGRID-Appliance-Knoten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Wenn DHCP auf Ports des Zielknotens aktiviert wird, die auf dem Quellknoten als statisch konfiguriert waren, muss sichergestellt sein, dass keine permanenten DHCP-Leases für MAC-Adressen des Quellknotens bestehen. Andernfalls kann es am Ende des Klonprozesses zu einem IP-Adresskonflikt kommen.
...
+
Quellknoten und Zielgerät können unterschiedliche Verschlüsselungseinstellungen aufweisen, mit folgenden Ausnahmen. Das Klonen von Knoten von unverschlüsselten Quellknoten zu node-verschlüsselten Zielgeräten wird für die folgenden Appliances nicht unterstützt:
...
** Eine SG1200-Knoten-Appliance ohne Knotenverschlüsselung zu einer SG1200-Appliance mit Knotenverschlüsselung
** Eine SG110-Knoten-Appliance ohne Knotenverschlüsselung zu einer SG110-Appliance mit Knotenverschlüsselung
** Eine SG120-Knoten-Appliance ohne Knotenverschlüsselung zu einer SG120-Appliance mit Knotenverschlüsselung
...
* Prüfen Sie, ob der RAID-Modus des Zielgeräts von der Standardeinstellung geändert werden soll, damit Sie diese Information bei der Erstinstallation des Zielgeräts vor dem Klonen angeben können. Sie können Informationen über den aktuellen RAID-Modus des Quell-Appliance-Knotens auf der Seite *Nodes* im Grid Manager anzeigen. Wählen Sie die Registerkarte *Hardware* für die Appliance aus.
+
