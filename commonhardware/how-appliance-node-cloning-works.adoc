...
* Klonvorgang läuft bereits
* Falsche Netzwerkkonfiguration
* Das Zielgerät kann den Primary Admin Node nicht erreichen.
* Fehlende Konnektivität zwischen Quell- und Ziel-Appliances
* Quell- und Zielgeräte sind nicht kompatibel
* Quell- und Zielgerät befinden sich in unterschiedlichen Wartungsmodus-Zuständen
* Die Versionen des StorageGRID Appliance Installers auf den Quell- und Zielgeräten stimmen nicht überein.
* Für Speicherknoten weist das Zielgerät inkompatiblen Speicher oder unzureichende Kapazität auf.
* Das Zielgerät ist nicht bereit
