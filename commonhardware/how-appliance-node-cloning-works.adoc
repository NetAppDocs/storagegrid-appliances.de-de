...
Das Klonen von Knoten von einer SGF6112-Quellknoten-Appliance ohne Knotenverschlüsselung auf ein SGF6112-Appliance-Ziel mit Knotenverschlüsselung wird nicht unterstützt.
