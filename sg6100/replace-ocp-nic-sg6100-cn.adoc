...
summary: 'Möglicherweise muss die Network Interface Card (NIC) im SG6100-CN ersetzt werden, wenn sie nicht optimal funktioniert oder ausgefallen ist.' 
---
= Ersetzen Sie eine externe Netzwerkkarte in einem SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Über diese Aufgabe
Um Dienstunterbrechungen zu vermeiden, stellen Sie sicher, dass alle anderen Speicherknoten mit dem Netz verbunden sind, bevor Sie mit dem Austausch der Netzwerkschnittstellenkarte (NIC) beginnen, oder ersetzen Sie die NIC während eines geplanten Wartungsfensters, wenn Zeiträume mit Dienstunterbrechungen akzeptabel sind.  Informationen zu https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["Verbindungsstatus des Knotens wird montierend dargestellt"^] .
