...
---
= Aktualisieren Sie das SANtricity Betriebssystem auf SG6100 Storage Controllern mithilfe des Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Für Storage-Controller, die derzeit SANtricity OS 08.42.20.00 (11.42) oder höher verwenden, können Sie ein Upgrade mit dem Grid-Manager oder dem Wartungsmodus durchführen.
