...
summary: Sie können den Grid Manager oder den Wartungsmodus verwenden, um ein Upgrade anzuwenden. 
---
= Aktualisieren Sie das SANtricity OS auf SG6160-Speichercontrollern mithilfe des Grid Managers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["Führen Sie ein Upgrade des SANtricity OS auf SG6100 Controllern mithilfe des Wartungsmodus durch"]
