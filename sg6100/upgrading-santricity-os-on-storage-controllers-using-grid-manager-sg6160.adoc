...
---
= Aktualisieren Sie das SANtricity Betriebssystem auf SG6160 Storage Controllern mithilfe des Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6160.html["Führen Sie ein Upgrade des SANtricity OS auf dem SG6160 Controller mithilfe des Wartungsmodus durch"]
