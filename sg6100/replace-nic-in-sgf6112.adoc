...
summary: 'Möglicherweise muss die Network Interface Card (NIC) im SGF6112 ersetzt werden, wenn sie nicht optimal funktioniert oder ausgefallen ist.' 
---
= Ersetzen Sie die interne Netzwerkkarte in einem SGF6112 oder SG6100-CN
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
