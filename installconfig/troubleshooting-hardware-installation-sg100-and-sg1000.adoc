...
---
= Fehlerbehebung bei der Hardwareinstallation für SG100 und SG1000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Wenn beim Starten der Appliance ein Hardwarefehler auftritt, meldet der BMC einen Fehlercode. Bei Bedarf können Sie diese Fehlercodes über die BMC-Schnittstelle oder den seriellen Port des Geräts anzeigen und dann mit dem technischen Support zusammenarbeiten, um das Problem zu lösen.
