---
permalink: installconfig/troubleshooting-hardware-installation-sg6200.html 
sidebar: sidebar 
keywords: storagegrid, sg6200, sgf6212, troubleshoot, troubleshooting, hardware, install, installation, boot codes, boot-up codes, start codes, codes, boot, start, bmc, error codes, setup, hang, hangs, fails, failure, stop, terminate, terminates, stuck, connection, sg6260, e4000 
...
---
= Fehlerbehebung bei der Hardwareinstallation für einen SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[view-boot-codesview-boot-up-codes-sgf6212-and-sg6260-only]]
== [[view-boot-codes]]Bootcodes anzeigen (nur SGF6212 und SG6260)
...
.. Vergewissern Sie sich, dass die vier Verbindungskabel zwischen dem SG6200-CN-Controller und den beiden Speichercontrollern fest angeschlossen sind.
...
[[view-error-codesview-error-codes-sgf6212-and-sg6260-only]]
== [[view-error-codes]]Fehlercodes anzeigen (nur SGF6212 und SG6260)
...
[[expansion-shelves-dont-appear-in-appliance-installer-sg6260]]
=== Erweiterungsregale werden im Appliance Installer (SG6260) nicht angezeigt.
...
. Vergewissern Sie sich, dass die Erweiterungsschränke eingeschaltet sind. Siehe link:connecting-power-cords-and-applying-power.html["Schließen Sie die Netzkabel an und schalten Sie die Stromversorgung ein (SG6200)"].
. Wenn Sie Hilfe bei der Behebung eines Problems benötigen, wenden Sie sich an den technischen Support.
