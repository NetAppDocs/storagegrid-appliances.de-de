...
* link:gathering-installation-information-sg120-and-sg1200.html["SG120 und SG1200"]
...
* *Managementnetzwerk für SANtricity* (optional für Storage Appliances, nicht erforderlich für die SGF6112 und SGF6212): Dieses Netzwerk bietet Zugriff auf SANtricity System Manager, sodass Sie die Hardwarekomponenten im Appliance- und Storage-Controller-Shelf überwachen und verwalten können. Dieses Managementnetzwerk kann dasselbe wie das Admin-Netzwerk für StorageGRID sein oder ein unabhängiges Managementnetzwerk.
* *BMC-Managementnetzwerk* (optional für SG6000, SG6100, SG6200 und Services Appliances): Dieses Netzwerk bietet Zugriff auf den Baseboard Management Controller in den SG6000, SG6100, SG6200 und Services Appliances und ermöglicht es Ihnen, die Hardwarekomponenten in der Appliance zu überwachen und zu verwalten. Dieses Managementnetzwerk kann dasselbe wie das Admin-Netzwerk für StorageGRID sein oder ein unabhängiges Managementnetzwerk.
+
