...
---
= Ändern des RAID-Modus für einen SG5760, SG5860, SG6000, SG6160 oder SG6260
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Sie können den RAID-Modus auf den folgenden Geräten ändern:
...
** DDP bietet Schutz vor Schubladenverlust in SG5760, SG5860, SG6160 und SG6260 Appliances.
+
