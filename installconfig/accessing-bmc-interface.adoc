...
summary: Auf die BMC-Schnittstelle kann bei einigen Gerätemodellen über die DHCP- oder statische IP-Adresse des BMC-Management-Ports zugegriffen werden. 
---
= Greifen Sie auf die BMC-Schnittstelle eines StorageGRID Geräts zu
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_bmc_management_port.png[BMC-Management-Port SG120]
...
.SG1200
--
image::../media/sg1200_bmc_management_port.png[BMC-Management-Port SG1200]
...
image::../media/sgf6212_bmc_management_port.png[BMC-Management-Port SGF6212]

_SG6200-CN_:

image::../media/sg6200_cn_bmc_management_port.png[BMC-Management-Port SG6200-CN]
