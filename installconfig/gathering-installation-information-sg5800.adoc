...
sidebar: sidebar 
keywords: storagegrid, sg5800, storage node, storage appliance, install, information, site, pre-install, preparing, prepare, preinstall, info, preparation, port bond, port bonding, port bond mode, port-bond mode, Network bond, Network bonding, Network bond mode, Network-bond mode, fixed, Aggregate, 10-gbe, 10 gbe, 25-gbe, 25 gbe, SG5800, independent, active-backup, active backup, 1-gbe, 1 gbe 
...
---
= Sammeln Sie Netzwerkinformationen für den SG5800
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[information-needed-to-connect-and-configure-1025-gbe-ports-on-sg5800-controller]]
