...
summary: 'Sie können eine Services-Appliance als primären Admin-Node, als nicht-primärer Admin-Node oder als Gateway-Node bereitstellen. Alle Service-Appliances können als Gateway-Nodes und Admin-Nodes (primär oder nicht primär) gleichzeitig ausgeführt werden.' 
---
= Stellen Sie einen StorageGRID Services-Appliance-Knoten bereit.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Wählen Sie den primären Admin-Knoten für das Grid aus, in dem dieses Appliance-Gateway oder dieser nicht primäre Admin-Knoten bereitgestellt wird.
.. Klicken Sie Auf *Speichern*.
.. Warten Sie, bis der Verbindungsstatus bereit ist, bis die neue IP-Adresse einsatzbereit ist.
...
+
Der hier angezeigte Name ist der Systemname des Appliance-Knotens.  Systemnamen sind für interne StorageGRID -Vorgänge erforderlich und können nicht geändert werden.  Informationen zum Ändern des Anzeigenamens eines Appliance-Knotens finden Sie unter https://docs.netapp.com/us-en/storagegrid/maintain/rename-grid-site-node.html#how-to-rename-grid-sites-or-nodes["So benennen Sie Raster, Sites oder Knoten um"^] .
...
Erfahren Sie mehr über link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["Konfiguration des Grid und Abschluss der Installation"^] und link:monitoring-appliance-installation.html["Überwachung der Geräteinstallation"].
