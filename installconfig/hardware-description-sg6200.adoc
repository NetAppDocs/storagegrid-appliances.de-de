...
+
--
* Ein AMD Prozessor mit 3,55 GHz, der 32 Kerne (64 Threads) bereitstellt
* 256 GB RAM
* 256 GB internes Bootlaufwerk (inkl. StorageGRID Software)
...
4
 a| 
Speicherkontroller der E-Serie E4000 (1 von 2) und Anschlüsse
