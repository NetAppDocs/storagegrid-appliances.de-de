...
---
= Zusätzliches Equipment und Werkzeug für StorageGRID-Geräte beschaffen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120 und SG1200
--
Für die Installation und Konfiguration der SG120- und SG1200-Hardware benötigen Sie folgende zusätzliche Ausrüstung.
...
** 40-GbE QSFP+
** 100-GbE-QSFP28
** 200-GbE QSFP56 (nur 200 GbE NIC)
