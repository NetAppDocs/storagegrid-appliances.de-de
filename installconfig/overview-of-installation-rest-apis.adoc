...
summary: 'StorageGRID bietet zwei REST-APIs zur Durchführung von Installationsaufgaben: die StorageGRID Installation API und die StorageGRID Appliance Installer API.' 
---
= StorageGRID Installation REST-APIs
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
