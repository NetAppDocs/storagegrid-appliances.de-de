...
. Stellen Sie sicher, dass die aktuelle Firmware-Version mit der auf Ihrem StorageGRID System installierten Softwareversion übereinstimmt.  (Wählen Sie oben im Grid Manager das Hilfesymbol und dann *Info* aus.)
