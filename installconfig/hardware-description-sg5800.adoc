...
summary: 'Die StorageGRID SG5800 Appliance ist eine integrierte Speicher- und Rechenplattform, die als Storage Node in einem StorageGRID Grid betrieben wird. Die Appliance kann in einer hybriden Grid-Umgebung verwendet werden, die Appliance Storage Nodes und virtuelle (softwarebasierte) Storage Nodes kombiniert.' 
---
= StorageGRID SG5800-Appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
