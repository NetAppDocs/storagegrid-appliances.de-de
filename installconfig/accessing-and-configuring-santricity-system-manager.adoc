...
---
= Konfigurieren Sie SANtricity für SG6260, SG6160, SG6000, SG5700 und SG5800 StorageGRID Appliances
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Folgende StorageGRID Appliances können auf SANtricity System Manager zugreifen:
...
* Laufwerkssicherheitsschlüssel, die zum Entsperren gesicherter Laufwerke benötigt werden
+

NOTE: Sie müssen den SANtricity System Manager einrichten und Zugriff darauf haben, wenn die Funktion „Laufwerkssicherheit“ für Ihr Appliance aktiviert ist.
...
.SG6060
--
Beim Speichergerät SG6060 kann die Laufwerkssicherheit auf den SSD-Laufwerken nur dann automatisch aktiviert werden, wenn vor der Installation des Speichergeräts die Schlüsselverwaltung konfiguriert wurde.
...
.. Erstellen Sie für das E2800-Controller-Shelf einen Sicherheitsschlüssel (eine Zeichenfolge, die vom Controller und den Laufwerken für den Lese- und Schreibzugriff gemeinsam genutzt wird).
+
...
.SG6260
--
Das Speichersystem SG6260 kann sowohl im SG6200-CN Compute-Controller als auch im E4000 Controller-Shelf mit FIPS-konformen Laufwerken ausgestattet werden. Die Laufwerksverschlüsselung wird für die SG6200-CN-Laufwerke und die E4000-Laufwerke separat konfiguriert.

.. link:optional-enabling-node-encryption.html#drive-encryption["Aktivieren Sie Die Laufwerkverschlüsselung"] für SED-SSDs, die im Rechenknoten SG6200-CN installiert sind.
.. Erstellen Sie einen Sicherheitsschlüssel (eine Zeichenkette, die vom Controller und den Laufwerken für Lese-/Schreibzugriff gemeinsam genutzt wird).
+
*** Sie können https://docs.netapp.com/us-en/e-series-santricity/sm-settings/create-internal-security-key.html["Erstellen Sie einen internen Schlüssel"^] aus dem persistenten Speicher des Controllers oder einen externen Schlüssel verwenden, der von einem Verschlüsselungsmanagement-Server bereitgestellt wird.
*** Um einen externen Schlüssel zu verwenden, der von einem Schlüsselverwaltungsserver bereitgestellt wird, müssen Sie zuerst https://docs.netapp.com/us-en/e-series-santricity/sm-settings/overview-drive-security.html["Einrichten der Authentifizierung mit einem Verschlüsselungsmanagement-Server"^] in SANtricity System Manager arbeiten.
...
NOTE: Führen Sie dieses Verfahren nur durch, wenn Sie keinen Zugriff auf den SANtricity System Manager über den StorageGRID Appliance Installer (*Advanced* > *SANtricity System Manager*) oder den Grid Manager (*Nodes* > *SANtricity System Manager*) haben.
