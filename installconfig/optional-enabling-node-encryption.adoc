...
Wenn Sie zusätzlich nach der Aktivierung der Knotenverschlüsselung den FIPS-Modus aktivieren, wird das NetApp StorageGRID Kernel Crypto API 6.1.129-1-ntap1-amd64 Modul zur Verschlüsselung von Daten im Ruhezustand verwendet. Weitere Informationen finden Sie unter  https://docs.netapp.com/us-en/storagegrid/admin/manage-tls-ssh-policy.html#select-a-security-policy["Wählen Sie eine Sicherheitsrichtlinie"^].
