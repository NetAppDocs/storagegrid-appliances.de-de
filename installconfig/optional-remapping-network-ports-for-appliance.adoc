...
.Über diese Aufgabe
Für Load Balancer-Endpunkte können keine neu zugeordneten Ports verwendet werden. Wenn Sie einen neu zugeordneten Port entfernen müssen, führen Sie die Schritte unter aus https://docs.netapp.com/us-en/storagegrid-118/maintain/removing-port-remaps.html["Entfernen Sie die Port-Remaps"^].
