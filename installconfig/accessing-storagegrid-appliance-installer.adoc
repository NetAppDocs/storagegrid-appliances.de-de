...
summary: 'Sie müssen auf den StorageGRID Appliance Installer zugreifen, um die Installer-Version zu überprüfen und die Verbindungen zwischen der Appliance und den drei StorageGRID Netzwerken zu konfigurieren: dem Grid Netzwerk, dem Admin Netzwerk (optional) und dem Client Netzwerk (optional).' 
---
= Zugriff auf den StorageGRID Appliance Installer
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.SG120
--
image::../media/sg120_admin_network_port.png[Admin-Netzwerkanschluss am SG120]
...
.SG1200
--
image::../media/sg1200_admin_network_port.png[Admin-Netzwerkanschluss am SG1200]
...
.SG6200-CN
--
image::../media/sg6200_cn_admin_network_port.png[Admin-Netzwerkanschluss am SG6200-CN-Controller]
...
.SGF6212
--
image::../media/sgf6212_admin_network_port.png[Admin-Netzwerkanschluss am SGF6212]
...
image::../media/sg120_link_local_port.png[SG120 Link-Local-Verbindung]
...
image::../media/sg1200_link_local_port.png[SG1200 Link-Local-Verbindung]
...
.SG6200-CN
--
Verbinden Sie einen Service-Laptop mithilfe eines Ethernet-Kabels direkt mit dem ganz rechts befindlichen RJ-45-Anschluss am SG6200-CN-Controller.

image::../media/sg6200_cn_link_local_port.png[Standort des Management-Ports für SG6200-CN]
...
image::../media/sgf6212_link_local_port.png[SGF6212 Link-Local-Verbindung]
