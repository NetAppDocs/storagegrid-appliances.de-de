...
---
= Statusanzeigen und Codes auf StorageGRID Geräten anzeigen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* <<appliance_indicators_sg120_sg1200,Gerätesteuchten und -Tasten>>
* <<general_boot_codes_sg120_sg1200,Allgemeine Startcodes>>
* <<ssd_indicators_sg120_sg1200,SSD-LEDs>>


Nutzen Sie diese Informationen, um link:troubleshooting-hardware-installation-sg120-and-sg1200.html["Fehlerbehebung bei der Hardwareinstallation von SG120 und SG1200"] zu helfen.

[[appliance_indicators_sg120_sg1200]]
Gerätesteuchten und -Tasten::
+
--
Die folgende Abbildung zeigt die Anzeigen und Tasten an der Vorderseite der SG120 und SG1200 Appliances.

image::../media/sg120_sg1200_front_indicators.png[Frontanzeigen - SG120 und SG1200]
...
PFR
 a| 
Diese Leuchte wird von den SG120- und SG1200-Appliances nicht verwendet und bleibt ausgeschaltet.

|===
--


Die folgende Abbildung zeigt die Position des Netzteils und der Identifizierungs-LEDs auf der Rückseite des SG120 und des SG1200. Zusätzliche Status- und Aktivitäts-LEDs befinden sich an den Appliance-Ports. Diese LEDs können je nach Appliance-Modell variieren.
...
|===
[[general_boot_codes_sg120_sg1200]]
Allgemeine Startcodes::
+
--
Beim Hochfahren oder nach einem harten Reset des Geräts treten folgende Aktionen auf:
...
[[ssd_indicators_sg120_sg1200]]
SSD-LEDs::
+
--
Die folgende Abbildung zeigt die SSD-Indikatoren auf den SG120- und SG1200-Appliances.
...
* <<appliance_indicators_SG6200,Gerätesteuchten und -Tasten>>
* <<general_boot_codes_SG6200,Allgemeine Startcodes>>
* <<ssd_indicators_SG6200,SSD-LEDs>>


Nutzen Sie diese Informationen, um link:troubleshooting-hardware-installation-sg6200.html["Fehlerbehebung bei der Hardwareinstallation des SG6200"] zu helfen.

[[appliance_indicators_SG6200]]
Gerätesteuchten und -Tasten::
+
--
Die folgende Abbildung zeigt die Anzeigen und Tasten an der Vorderseite der SG6200-Geräte.

image::../media/s25_front_indicators.png[Frontanzeigen - SG6200]
...
PFR
 a| 
Diese Leuchte wird von SG6200-Geräten nicht verwendet und bleibt ausgeschaltet.

|===
--


Die folgende Abbildung zeigt die Position des Netzteils und der Identifizierungs-LEDs auf der Rückseite der SGF6212 und SG6200-CN. Zusätzliche Status- und Aktivitäts-LEDs befinden sich an den Appliance-Ports. Diese LEDs können je nach Appliance-Modell variieren.

image::../media/s25_rear_leds.png[Hintere LEDs SGF6212 und SG6200-CN]
...
[[ssd_indicators_SG6200]]
SSD-LEDs::
+
--
Die folgende Abbildung zeigt SSD-Indikatoren auf der SGF6212- oder SG6260-Appliance.
...
*Hinweis:* Wenn eine neue, funktionierende SSD in einen funktionierenden SGF6212- oder SG6260 StorageGRID Node eingesetzt wird, sollten die LEDs auf der SSD zunächst blinken, aber aufhören zu blinken, sobald das System feststellt, dass das Laufwerk über ausreichende Kapazität verfügt und funktionsfähig ist.
