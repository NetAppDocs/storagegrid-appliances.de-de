...
---
= Legen Sie die IP-Adresse des BMC-Management-Ports auf einem StorageGRID Gerät fest
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Notieren Sie sich in den LAN-IP-Einstellungen die automatisch angezeigte IPv4-Adresse.
+
