...
---
= Schnellstart für die Installation der StorageGRID-Appliance
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
** link:installing-appliance-in-cabinet-or-rack-sg120-and-sg1200.html["SG120 und SG1200"]
...
. link:accessing-and-configuring-santricity-system-manager.html["Aufrufen und Konfigurieren von SANtricity System Manager"] (SG6260, SG6160, SG5700, SG5800 und SG6000)
. link:configuring-bmc-interface.html["Konfigurieren Sie die BMC-Schnittstelle"] (SG6200, SG6100, SG6000 und Services-Appliances)
...
** link:optional-changing-raid-mode.html["RAID-Modus ändern"] (SG6260, SG6160, SG6000, SG5860 und SG5760)
...
.image:https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-5.png["Fünf"] Konfiguration
[role="quick-margin-para"]
Wenn alle Knoten bereitgestellt wurden, verwenden Sie den Grid Manager, um link:https://docs.netapp.com/us-en/storagegrid/swnodes/navigating-to-grid-manager.html["Konfigurieren Sie das Grid und schließen Sie die Installation ab"^].
