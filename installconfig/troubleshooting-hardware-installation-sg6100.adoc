...
---
= Fehlerbehebung bei der Hardwareinstallation für einen SG5800 oder SG6100
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[view-boot-codesview-boot-up-codes-sgf6112-and-sg6160-only]]
...
[[view-error-codesview-error-codes-sgf6112-and-sg6160-only]]
...
[[expansion-shelves-dont-appear-in-appliance-installer-sg6160]]
