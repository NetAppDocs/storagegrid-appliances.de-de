---
permalink: installconfig/gathering-installation-information-sg6200.html 
sidebar: sidebar 
keywords: storagegrid, sg6200, sgf6212, SG6260, install, information, site, pre-install, preparing, prepare, preinstall, info, preparation, port bond, port bonding, port bond mode, port-bond mode, Network bond, Network bonding, Network bond mode, Network-bond mode, independent, active-backup, active backup 
...
---
= Sammeln Sie Netzwerkinformationen für den SG6200
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Bevor Sie ein SGF6212- oder SG6260-Gerät installieren, vergewissern Sie sich, dass Ihr StorageGRID System eine erforderliche Version der StorageGRID Software verwendet.
...
Verbinden Sie beide Speichercontroller des SG6260-Geräts mit dem Managementnetzwerk, das Sie für SANtricity System Manager verwenden. Controller A befindet sich oben und Controller B befindet sich unten.
...
RJ-45-Anschlüsse am SGF6212-Gerät:

image::../media/sgf6212_rj_45_ports.png[SGF6212 RJ-45-Anschlüsse]

RJ-45-Anschlüsse am SG6200-CN-Controller:

image::../media/sg6200_cn_rj_45_ports.png[SG6200-CN RJ-45-Anschlüsse]
...
Die folgenden Abbildungen zeigen den BMC-Management-Port auf dem SGF6212 und SG6200-CN.

_SGF6212_

image::../media/sgf6212_bmc_management_port.png[SGF6212 Management-Port]

_SG6200-CN_

image::../media/sg6200_cn_bmc_management_port.png[SG6200-CN Management-Port]
...
Wenn Sie link:configuring-network-links.html["Netzwerk-Links werden konfiguriert"] für das SGF6212-Gerät verwenden, können Sie Port-Bonding für die Ports nutzen, die mit dem Grid-Netzwerk und dem optionalen Client-Netzwerk verbunden sind, sowie für die 1/10-GbE-Management-Ports, die mit dem optionalen Admin-Netzwerk verbunden sind. Port-Bonding trägt zum Schutz Ihrer Daten bei, indem es redundante Pfade zwischen StorageGRID-Netzwerken und dem Gerät bereitstellt.
...
image::../media/sgf6212_bonded_management_ports.png[SGF6212 Netzwerkmanagement-Ports]

_SG6200-CN:_

image::../media/sg6200_cn_bonded_management_ports.png[SG6200-CN Netzwerkmanagement-Ports]
