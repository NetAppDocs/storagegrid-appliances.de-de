...
[role="lead"]
Gehe zu https://docs.netapp.com/us-en/storagegrid/index.html["StorageGRID 12.0 Dokumentation"^] um zu erfahren, wie Sie ein StorageGRID 12.0-System konfigurieren und verwenden.
