...
[role="lead"]
Informationen zur Konfiguration und Nutzung eines StorageGRID 12.1 Systems sind unter  https://docs.netapp.com/us-en/storagegrid/index.html["StorageGRID 12.1 Dokumentation"^] verfügbar.
...
* https://docs.netapp.com/us-en/storagegrid-120/index.html["StorageGRID 12.0-Dokumentation"^]
* https://docs.netapp.com/us-en/storagegrid-119/index.html["StorageGRID 11.9-Dokumentation"^]
