...
---
= Tauschen Sie die CMOS-Batterien in einem SG120 oder SG1200 aus
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Gehen Sie wie folgt vor, um die beiden CMOS-Knopfzellenbatterien auf der Systemplatine auszutauschen.

.Über diese Aufgabe
Um Serviceunterbrechungen zu vermeiden, vergewissern Sie sich, dass alle anderen Servicegeräte mit dem Grid verbunden sind und Hochverfügbarkeitsgruppen konfiguriert wurden (falls zutreffend), bevor Sie mit dem Austausch der CMOS-Batterie beginnen, oder tauschen Sie die Batterien während eines geplanten Wartungsfensters aus, wenn Serviceunterbrechungen akzeptabel sind. Siehe die Informationen über https://docs.netapp.com/us-en/storagegrid/monitor/monitoring-system-health.html#monitor-node-connection-states["Monitoring der Verbindungsstatus der Nodes"^].

.Bevor Sie beginnen
* Du hast link:verify-component-to-replace.html["SG120 oder SG1200 überprüft, bei denen die CMOS-Batterien ausgetauscht werden müssen"].
* Sie haben die richtigen Ersatz-CMOS-Batterien (CR2032) erhalten.
* Sie haben link:locating-sg120-and-sg1200-in-data-center.html["physisch den Standort des SG120- oder SG1200-Appliance bestimmen"]wo Sie die CMOS-Batterien im Rechenzentrum austauschen.
