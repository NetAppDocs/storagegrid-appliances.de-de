---
permalink: sg120-1200/power-sg120-and-sg1200-off-on.html 
sidebar: sidebar 
keywords: storagegrid, sg120, sg1200, power off, turn off, shut off, shutdown, shut down, power on, turn on, start 
summary: Sie können das SGF6112-Gerät herunterfahren und wieder einschalten, um Wartungsarbeiten durchzuführen. 
---
= Schalten Sie SG120 oder SG1200 aus und wieder ein
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können das SG120 oder SG1200 Appliance ausschalten und anschließend wieder einschalten, um Wartungsarbeiten durchzuführen.



[[shut-down-the-sg120-or-sg1200-appliance]]
== Fahren Sie das SG120- oder SG1200-Gerät herunter.
...
[[power-on-sg120-or-sg1200-and-verify-operation]]
== Schalten Sie SG120 oder SG1200 ein und überprüfen Sie den Betrieb.

Schalten Sie den Controller nach dem Abschluss der Wartung ein.

.Bevor Sie beginnen
* Sie haben link:reinstalling-sg120-and-sg1200-into-cabinet-or-rack.html["Controller in einem Schrank oder Rack installiert"] und die Daten- und Stromkabel angeschlossen.
* Du hast link:locating-sg120-and-sg1200-in-data-center.html["Standort des Controllers im Datacenter"].
