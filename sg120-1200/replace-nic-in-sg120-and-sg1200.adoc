...
summary: 'Möglicherweise müssen Sie die Netzwerkkarte (NIC) im SG120 oder SG1200 austauschen, wenn sie nicht optimal funktioniert oder ausgefallen ist.' 
---
...
NOTE: Das SG1200 Appliance unterstützt schnellere Netzwerk-Ports und möglicherweise sind schnellere NICs installiert.
