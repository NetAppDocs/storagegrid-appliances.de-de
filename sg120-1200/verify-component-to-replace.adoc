...
---
= Prüfen Sie, welches Bauteil im SG120 oder SG1200 ausgetauscht werden soll.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
link:turning-sg120-and-sg1200-identify-led-on-and-off.html["Schalten Sie die Appliance Identify-LED ein"]
