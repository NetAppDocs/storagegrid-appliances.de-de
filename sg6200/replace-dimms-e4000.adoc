---
permalink: sg6200/replace-dimms-e4000.html 
sidebar: sidebar 
keywords:  
summary:  
---
= Austausch der DIMMs im Speichercontroller-Einschub (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein DIMM im E4000 ersetzen, wenn ein Speicherfehler vorliegt oder wenn ein DIMM-Fehler vorliegt.
...
+
*** Wählen Sie im Grid Manager *Knoten* > *Geräteknoten* > *SANtricity System Manager*. Die Controller-Informationen befinden sich auf der  https://docs.netapp.com/us-en/storagegrid/monitor/viewing-santricity-system-manager-tab.html["Registerkarte „SANtricity System Manager“"].
...
. Wählen Sie im Recovery Guru *erneut prüfen* aus, und bestätigen Sie, dass das Feld OK to remove im Detailbereich angezeigt wird
Zeigt Yes an und zeigt an, dass diese Komponente sicher entfernt werden kann.
...
. Starten Sie den Controller-Behälter neu.
...
. Klicken Sie auf *Hardware › Support › Upgrade Center*, um sicherzustellen, dass die neueste Version von SANtricity OS installiert ist.
+
