...
summary: Möglicherweise müssen Sie den SG6200-CN-Controller ersetzen, wenn er nicht optimal funktioniert oder ausgefallen ist. 
---
= SG6200-CN-Controller ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Möglicherweise müssen Sie den SG6200-CN-Controller ersetzen, wenn er nicht optimal funktioniert oder ausgefallen ist.

.Über diese Aufgabe
Der Speicherknoten des Geräts ist nach dem Austausch des SG6200-CN-Controllers nicht zugänglich. Falls der SG6200-CN-Controller ausreichend funktionsfähig ist, können Sie zu Beginn dieses Vorgangs ein kontrolliertes Herunterfahren durchführen.
...
+
link:locating-sg6200-in-data-center.html["Controller im Datacenter finden"]
...
. Wenn der SG6200-CN-Controller ausreichend funktioniert, um ein kontrolliertes Herunterfahren zu ermöglichen, link:power-sg6200-off-on.html["Fahren Sie den SG6200-CN-Controller herunter"].
...
. Den SG6200-CN-Controller ausbauen und ersetzen:
+
