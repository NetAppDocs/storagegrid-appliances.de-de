---
permalink: sg6200/replace-e4000-fan-canister.html 
sidebar: sidebar 
...
---
= Lüftergehäuse im Speichercontroller-Fach oder Erweiterungsfach (SG6260) austauschen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können einen Lüfterzylinder in einem SG6260 austauschen.
