---
permalink: sg6200/power-sg6200-off-on.html 
sidebar: sidebar 
keywords: storagegrid, sgf6212, sg6200, power off, turn off, shut off, shutdown, shut down, power on, turn on, start 
summary: Sie können das SG6200 Appliance ausschalten und anschließend wieder einschalten, um Wartungsarbeiten durchzuführen. 
---
= SGF6212 Appliance oder SG6200-CN Controller aus- und einschalten
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können das Gerät SGF6212 oder den Controller SG6200-CN herunterfahren und anschließend wieder einschalten, um Wartungsarbeiten durchzuführen.



[[shut-down-the-sgf6212-appliance-or-sg6200-cn-controller]]
== Schalten Sie das SGF6212-Gerät oder den SG6200-CN-Controller aus
...
[[power-on-sgf6212-or-sg6200-cn-and-verify-operation]]
== Schalten Sie SGF6212 oder SG6200-CN ein und überprüfen Sie den Betrieb.

Schalten Sie den Controller nach dem Abschluss der Wartung ein.

.Bevor Sie beginnen
* Sie haben link:reinstalling-sg6200-into-cabinet-or-rack.html["Controller in einem Schrank oder Rack installiert"] und die Daten- und Stromkabel angeschlossen.
* Du hast link:locating-sg6200-in-data-center.html["Standort des Controllers im Datacenter"].
