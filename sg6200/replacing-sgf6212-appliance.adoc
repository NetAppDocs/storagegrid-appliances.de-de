...
.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Entfernen Sie das fehlerhafte Gerät aus dem Schrank oder Rack"].
...
+
image::../media/sgf6212_front_with_ssds.png[Lüfterpositionen]
...
CAUTION: Wenn Sie die Daten auf den Laufwerken behalten möchten, setzen Sie die SSD-Laufwerke unbedingt in dieselben Laufwerksschächte ein, die sie im ausgefallenen Gerät belegten. Wenn Sie dies nicht tun, zeigt der Appliance Installer eine Warnmeldung an und Sie müssen die Laufwerke in die richtigen Schächte einsetzen und das Gerät neu starten, bevor das Gerät dem Grid wieder beitreten kann.

.. link:reinstalling-sg6200-into-cabinet-or-rack.html["Setzen Sie das Ersatzgerät in den Schrank oder das Rack ein"].
...
* link:../installconfig/troubleshooting-hardware-installation-sg6200.html#view-boot-codes["Anzeigen von Startcodes für die Appliance"]
