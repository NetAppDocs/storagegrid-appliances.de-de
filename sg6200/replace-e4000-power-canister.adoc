---
permalink: sg6200/replace-e4000-power-canister.html 
sidebar: sidebar 
...
---
= Netzteilkanister im Speicher-Controller-Shelf oder Erweiterungs-Shelf (SG6260) austauschen
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können eine Stromversorgungsdose in einem SG6260 Storage Controller Shelf oder Expansion Shelf (DE460C) austauschen.
