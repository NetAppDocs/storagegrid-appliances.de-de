...
summary: 'Für Speicherkontroller, die derzeit SANtricity OS 08.42.20.00 (11.42) oder neuer verwenden, besteht die Möglichkeit, das Upgrade über den Grid Manager oder den Wartungsmodus durchzuführen.' 
---
= Aktualisieren Sie SANtricity OS auf SG6200-Speichercontrollern mithilfe von Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können den Grid Manager oder den Wartungsmodus verwenden, um ein Upgrade anzuwenden.
...
Der Vorgang ist erst abgeschlossen, wenn das SANtricity OS-Upgrade erfolgreich auf alle für das Upgrade ausgewählten Knoten angewendet wurde.  Das Laden des SANtricity -Betriebssystems auf jedem Knoten (nacheinander) kann mehr als 30 Minuten dauern und der Neustart jedes StorageGRID Speichergeräts kann bis zu 90 Minuten dauern.  Knoten in Ihrem Grid, die SANtricity OS nicht verwenden, sind von diesem Verfahren nicht betroffen.
...
NOTE: Wenden Sie den neuesten StorageGRID -Hotfix an, bevor Sie mit diesem Verfahren beginnen. Sehen https://docs.netapp.com/us-en/storagegrid/maintain/storagegrid-hotfix-procedure.html["StorageGRID Hotfix Verfahren"^] für Details.
...
+
Wählen Sie die SANtricity OS-Version für Ihre Speichercontroller.
...
** Wählen Sie eine oder mehrere *Genehmigen*-Schaltflächen aus, um einen oder mehrere Knoten zur SANtricity OS-Upgrade-Warteschlange hinzuzufügen. Die Schaltfläche *Genehmigen* ist deaktiviert, wenn der Status nicht Nominal ist.
+
...
Keine weiteren Maßnahmen erforderlich.
 ...
 a| 
SANtricity OS-Upgrade ist für diesen Knoten nicht anwendbar.
 a| 
Der Node verfügt nicht über einen Storage Controller, der vom StorageGRID System gemanagt werden kann. Schließen Sie das Upgrade ab, ohne den Node mit dieser Meldung zu aktualisieren.
 ...
 a| 
SANtricity OS-Datei ist mit diesem Knoten nicht kompatibel.
 a| 
...
. Wiederholen Sie diesen Upgrade-Vorgang für Knoten im Status „Abgeschlossen“, die eine andere SANtricity OS-Upgrade-Datei erfordern.
+

NOTE: Verwenden Sie für Knoten mit dem Status „Benötigt Aufmerksamkeit“ den Wartungsmodus, um das Upgrade durchzuführen.



.Verwandte Informationen
* https://mysupport.netapp.com/matrix["NetApp Interoperabilitäts-Matrix-Tool"^]
* link:upgrading-santricity-os-on-storage-controllers-using-maintenance-mode-sg6260.html["Aktualisieren Sie SANtricity OS auf SG6200-Controllern im Wartungsmodus"]
