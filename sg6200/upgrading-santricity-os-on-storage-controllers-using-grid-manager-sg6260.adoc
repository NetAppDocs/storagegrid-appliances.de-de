...
summary: 'Für Storage-Controller, die derzeit SANtricity OS 08.42.20.00\(11.42 \) oder höher verwenden, können Sie ein Upgrade mit dem Grid Manager oder dem Wartungsmodus durchführen.' 
---
