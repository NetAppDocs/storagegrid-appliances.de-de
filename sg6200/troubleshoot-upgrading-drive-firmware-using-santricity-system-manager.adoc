---
permalink: sg6200/troubleshoot-upgrading-drive-firmware-using-santricity-system-manager.html 
sidebar: sidebar 
keywords: storagegrid, troubleshoot, storage node, storage appliance, upgrade, upgrading, firmware, drive, disk, SANtricity System Manager, SANtricity 
...
---
= Fehlerbehebung bei Upgrade-Fehlern der Laufwerk-Firmware (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
