---
permalink: sg6200/upgrading-drive-firmware-using-santricity-system-manager-online.html 
sidebar: sidebar 
...
---
= Upgrade der SG6200-Laufwerk-Firmware mit der Online-Methode des SANtricity System Manager (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
