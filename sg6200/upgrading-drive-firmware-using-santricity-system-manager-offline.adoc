---
permalink: sg6200/upgrading-drive-firmware-using-santricity-system-manager-offline.html 
sidebar: sidebar 
keywords: storagegrid, sg6200, storage node, storage appliance, upgrade, upgrading, firmware, drive, disk, SANtricity System Manager, SANtricity 
...
---
= Upgrade der SG6200-Laufwerk-Firmware mit SANtricity System Manager über die Offline-Methode (SG6260)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Dieses Verfahren gilt *nicht* für die NVMe-SSDs im SG6200-CN, die während StorageGRID-Software-Upgrades aktualisiert werden. Nur Laufwerke im E4000 können mit diesem Verfahren aktualisiert werden.
...
** Verwenden Sie den Grid Manager und wählen Sie *Knoten* > *_Speicherknoten_* > *SANtricity System Manager*
