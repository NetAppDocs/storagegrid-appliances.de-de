---
permalink: sg6200/replace-controller-e4000-duplex.html 
sidebar: sidebar 
keywords:  
summary:  
---
= E4000 Storage-Controller (SG6260) ersetzen
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Wenn Sie die Appliance während dieses Vorgangs in den Wartungsmodus versetzt haben, beenden Sie den Wartungsmodus und warten Sie, bis der Knoten neu gestartet wird und sich wieder dem Grid anschließt.  Dieser Vorgang kann bis zu 20 Minuten dauern.  So bestätigen Sie, dass der Neustart abgeschlossen ist und der Knoten wieder dem Grid beigetreten ist:
+
