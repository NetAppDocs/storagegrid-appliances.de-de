...
---
= Aktualisieren Sie das SANtricity Betriebssystem auf SG5800 Storage Controllern mithilfe des Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Für Storage-Controller, die derzeit SANtricity OS 08.42.20.00 (11.42) oder neuer verwenden, können Sie mit dem Grid Manager ein Upgrade anwenden. Das können Sie auch link:upgrading-santricity-os-on-storage-controller.html["Verwenden Sie den Wartungsmodus, um ein Upgrade anzuwenden"].
