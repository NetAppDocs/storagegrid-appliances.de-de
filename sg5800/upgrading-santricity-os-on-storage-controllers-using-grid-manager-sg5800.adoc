...
summary: Sie können den Grid Manager verwenden, um ein Upgrade anzuwenden. 
---
= Aktualisieren Sie das SANtricity OS auf SG5800-Speichercontrollern mithilfe des Grid Managers
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können den Grid Manager verwenden, um ein Upgrade anzuwenden. Sie können auch link:upgrading-santricity-os-on-storage-controller.html["Verwenden Sie den Wartungsmodus, um ein Upgrade anzuwenden"].
