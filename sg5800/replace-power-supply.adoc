...
summary: Sie können ein Netzteil im SG5812 austauschen. 
---
= Ersetzen Sie das Netzteil im SG5812
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Netzteil in einem SG5812 austauschen.

.Über diese Aufgabe
Wenn Sie ein Netzteil austauschen möchten, beachten Sie die folgenden Anforderungen.

* Sie benötigen ein Ersatznetzteil, das für Ihr Gerät unterstützt wird.
...
+
** Ein Ersatznetzteil, das für Ihr Controller-Gerätelodell unterstützt wird.
...
Bereiten Sie den Austausch eines Netzteils vor.
