...
summary: Sie können ein Laufwerk im SG5860 austauschen. 
---
= Ersetzen Sie ein Laufwerk im SG5860
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sie können ein Laufwerk in einem SG5860 austauschen.
...
Dieses Verfahren gilt für DCM- und DCM2-Laufwerkseinschübe.
