...
summary:  
---
= Tauschen Sie die Batterie im E4000-Controller in einem SG5800 aus.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Bestätigen Sie, dass der Neustart abgeschlossen ist und der Knoten wieder dem Grid beigetreten ist:
+
...
NOTE: Vom Einschalten der Netzschalter bis zur Wiederherstellung der Verbindung des Knotens mit dem Netz und der Anzeige eines normalen Status im Grid Manager können 20 Minuten vergehen.
