...
---
= Schalten Sie den SG6000-CN Controller aus und wieder ein
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[[poweronpower-on-sg6000-cn-controller-and-verify-operation]]
== [[poweron]]Schalten Sie den SG6000-CN-Controller ein und überprüfen Sie die Funktion.
