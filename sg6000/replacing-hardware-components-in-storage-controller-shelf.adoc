...
---
= Tauschen Sie die Hardwarekomponenten im SG6000-Speichercontroller-Gehäuse aus
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Anweisungen zu den anderen Field Replaceable Units (FRUs) in den Controller-Shelfs finden Sie auf der https://docs.netapp.com/us-en/e-series-family/index.html["E-Series Verfahren für die Systemwartung"^].
