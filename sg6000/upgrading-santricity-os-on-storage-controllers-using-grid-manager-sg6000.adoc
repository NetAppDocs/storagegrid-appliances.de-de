...
summary: 'Bei Storage-Controllern, die derzeit SANtricity OS 08.42.20.00 (11.42) oder eine neuere Version verwenden, müssen Sie zum Anwenden eines Upgrades den Grid-Manager verwenden.' 
---
= Aktualisieren Sie das SANtricity OS auf SG6000-Speichercontrollern mit Grid Manager
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
