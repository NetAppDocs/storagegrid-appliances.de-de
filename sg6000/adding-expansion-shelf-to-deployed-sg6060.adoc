...
---
= Fügen Sie einer bereits im Einsatz befindlichen SG6060 Appliance ein Erweiterungsgehäuse hinzu.
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Sie erhalten das Erweiterungsfach und vier SAS-Kabel für jedes Erweiterungsfach.
...
+
Beispiele für Meldungen, die je nach Anzahl vorhandener oder neuer Erweiterungsregale auf der Startseite erscheinen können:
...
+
Wenn der Neustart abgeschlossen ist, wird die Registerkarte *Aufgaben* mit Auswahlmöglichkeiten zum Neustarten des Knotens oder zum Versetzen der Appliance in den Wartungsmodus angezeigt.
